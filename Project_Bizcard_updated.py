...
def extracted_text(picture):
    ...
    for m in range(2, len(result)):
        ...
        elif re.match(r'^[A-Z,a-z]', result[m]):
...
if selected == "Contact":
    name = "Rajkumar Vijay"
    mail = (f'{"Mail :"}  {"raj_amudha07@yahoo.co.in"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/Rajkumar0108/Rajkumar0108.git",
        "LINKEDIN": "https://www.linkedin.com/in/rajkumar-vijay-ba225227b/"}
